...
export const posController = {
   ...
   */
  async startSale(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getSaleSummary(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getQuickProducts(req: Request, res: Response): Promise<void> {
    try {
      const businessId = 1; // Por defecto
   ...
   */
  async assignCustomerToCart(req: Request, res: Response): Promise<void> {
    try {
      const {cartId} = req.params;
