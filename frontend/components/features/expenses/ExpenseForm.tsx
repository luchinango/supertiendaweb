...
export function ExpenseForm() {
  ...
  const handleCreateExpense = useCallback(() => {
    ...
    // Close the form
    closeExpenseForm()
  }, [isDebt, selectedDate, selectedCategory, value, expenseName, selectedSupplier, paymentMethod, closeExpenseForm])
  ...
  const handleToggleSupplierDropdown = useCallback(() => {
            ...
            <div className="space-y-2 relative">
              ...
              <div className="relative">
                {selectedSupplier ? (
                  ...
                  <div className="relative" onClick={handleToggleSupplierDropdown}>
