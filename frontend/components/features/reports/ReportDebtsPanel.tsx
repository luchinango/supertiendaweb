...
interface ReportDebtsPanelProps {
  isOpen: boolean
  onClose: () => void
}

export function ReportDebtsPanel({ isOpen, onClose }: ReportDebtsPanelProps) {
      ...
      <div className="relative w-full max-w-md bg-white h-full overflow-y-auto shadow-xl animate-slide-in-from-right">
        <div className="p-6 flex flex-col h-full">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold">Reporte de deudas</h2>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-6">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-blue-700">
                Todas las ventas por cobrar y gastos por pagar que tienes acumulados hasta hoy.
              </p>
            </div>
          </div>
